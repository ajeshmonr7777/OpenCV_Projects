...
int main()
{
    ...
    Mat bg = imread("Resources/cards.jpg");

    resize(bg, bg, Size(1280, 720));
    ...
    while (1)
    {
        ...
        if (frame.data)
        {
            ...
            else
            {
                ...
                resize(resultSourceImg, resultSourceImg, Size(1280, 720));
               
                resize(resultSourceImg3, resultSourceImg3, Size(1280, 720));

                resize(frameGlobal, frameGlobal, Size(1280, 720));
