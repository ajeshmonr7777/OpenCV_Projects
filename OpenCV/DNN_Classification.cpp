...
int main(int, char**) {
    ...
    ifstream ifs(string("Resources/input/classification_classes_ILSVRC2012.txt").c_str());
    string line;
    ...
    auto model = readNet("Resources/input/DenseNet_121.prototxt",
        "Resources/input/DenseNet_121.caffemodel",
        "Caffe");

    // load the image from disk
    Mat image = imread("Resources/input/imgg1.jpeg");
    ...
    imshow("Image", image);
    waitKey(0);
    //imwrite("Resources/outputs/result_image.jpg", image);
}